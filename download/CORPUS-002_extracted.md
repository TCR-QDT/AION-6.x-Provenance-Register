# CORPUS-002 — Extração de Texto Estruturado

**Arquivo de origem:** `Paper_A_v6.2_FINAL.pdf`
**ID do Corpus:** CORPUS-002
**Extração realizada em:** 2026-08-16T20:39:13+00:00
...
|---|---|
| format | PDF 1.5 |
| title | Relational Coherence in Biological Networks |
| author | Edson C. do Nascimento |
| subject |  |
| keywords |  |
| creator | LaTeX with hyperref |
| producer | xdvipdfmx (0.1) |
| creationDate | D:20260812212209-00'00' |
| modDate |  |
| trapped |  |
| encryption | None |
| _page_count | 6 |
| _file_size_bytes | 134294 |
...
(iii) a sleep/wake classification task on real 32-channel
EEG data from the OpenNeuro ds003768 dataset [4]
(P3). We further subject the metric to sensitivity analy-
sis (Sobol) and a computational triviality test (Aaronson
criterion [5]).
...
- Linha 3: `THE RELATIONAL COHERENCE METRIC`
- Linha 22: `I = 1`
- Linha 33: `I = 1`
- Linha 71: `H = −∑`
...
- Linha 7: `III.`
- Linha 8: `EMPIRICAL VALIDATION`
- Linha 130: `• F1: 0.686 ± 0.152`
- Linha 131: `• AUC: 0.793 ± 0.133`
- Linha 133: `TABLE`
- Linha 134: `III.`
- Linha 137: `results`
- Linha 139: `EEG,`
...
- Linha 37: `I + S + H`
- Linha 41: `I + S + H + C`
- Linha 68: `SENSITIVITY ANALYSIS`
- Linha 83: `• SI = 0.350`
- Linha 84: `• SS = 0.376`
- Linha 85: `• SH = 0.095`
- Linha 129: `DISCUSSION: LIMITATIONS AND OPEN`
- Linha 130: `ISSUES`
...
- Linha 7: `C = I × S × R1.3 × H0.5`
- Linha 116: `CONCLUSION`
...
- P2: `log |Aut| ≈∑`
- P2: `ℓ˜λℓlog2 ˜λℓ`
- P2: `For each β in a grid β ∈[0.1, 1.5] (15 values), we com-`
- P3: `0.734 ± 0.114 0.793 ± 0.133`
- P5: `exponents α and β were originally fitted on the same sys-`
- P5: `scale index η claimed “commensurability” between δβ`
- P5: `commensurability as |δβ −δST |/δβ < 0.2. With current`
- P5: `Cosmological predictions (Λ, ηB) were back-`
